...
print(f"Treningowe: {len(X_train)}, Testowe: {len(X_test)}")
print(f"Ukryte neurony: {hidden_size} (10 dla A, 8 dla B, 8 dla C, 8 dla D, 8 dla E)")

print("\n" + "="*60)
print("TRAINING SIECI NEURONOWEJ (softmax + crossentropy)")
print("="*60)

model = SimpleNN(24, hidden_size, 5, learning_rate=0.5)
model.train(X_train, y_train_onehot, epochs=300)
...
save_path = os.path.join(base_path, "neural_net_70_30_v2.pkl")
